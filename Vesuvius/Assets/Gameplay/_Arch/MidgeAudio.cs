...
{
    public class MidgeAudio : MonoBehaviour
    {
        [Header("References")]
        ...
        public void PlayMidgeWalk()
        {
            ...
            AkSoundEngine.PostEvent("Play_MidgeWalk", gameObject);
        }

        public void StopMidgeWalk()
        {
            // Get Openness value for the current scene
            float opennessValue = GetOpennessForCurrentScene();
            ...
            // Play the footstep event
            AkSoundEngine.PostEvent("Stop_MidgeWalk", gameObject);
        }
