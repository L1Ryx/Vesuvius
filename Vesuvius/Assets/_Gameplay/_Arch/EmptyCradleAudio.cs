...
{
    public class EmptyCradleAudio : MonoBehaviour
    {
        [Header("References")]
        ...
        public void PlayUINavigate()
        {
            ...
            AkSoundEngine.PostEvent("Play_UINavigate", gameObject);
        }
        ...
        public void PlayShovelSequence()
        {
            // Get Openness value for the current scene
            float opennessValue = GetOpennessForCurrentScene();
            ...
            AkSoundEngine.PostEvent("Play_ShovelSequence", gameObject);
        }
